...
/* Metronic App */
var FarabiLoginApp = angular.module("FarabiLoginApp", [
...
$.ajax({
        ...
        success: function(data) {
            //stuff
            //...
            FarabiLoginApp.config(function($translateProvider) {
...
FarabiLoginApp.run(['$rootScope', '$translate', '$log', function ($rootScope, $translate, $log) {
...
FarabiLoginApp.controller('BasicCtrls', ['$scope','$translate', function($scope,$translate) {
    $scope.greeting = 'Hola!';
